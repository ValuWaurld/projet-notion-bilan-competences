...
export const questions: Question[] = [
    ...
    {
        "question": "Qui a étudié à l'étranger ?",
        "khaledEmotion": "smirk",
        "valentinEmotion": "hesitate",
        "answers": [
            {
                "value": "Khaled",
                "correct": true,
                "khaledResponse": "Oui, j'ai étudié à l'étranger pendant quelques années. C'était une expérience enrichissante !",
                "khaledEmotion": "wink",
                "valentinResponse": "Non, je suis resté dans mon pays natal pour mes études. J'ai préféré rester proche de chez moi.",
                "valentinEmotion": "happy"
            },
            {
                "value": "Valentin",
                "correct": false,
                "khaledResponse": "Non, c'est moi qui ai étudié à l'étranger. Valentin est plutôt du genre à rester près de chez lui.",
                "khaledEmotion": "sad",
                "valentinResponse": "Non, je n'ai pas eu cette expérience. Je suis plutôt resté concentré sur mes études sans me préoccuper d'apprendre une nouvelle langue.",
                "valentinEmotion": "sweat"
            }
        ]
    },
    {
        "question": "Qui privilégie une entreprise proche de son domicile ?",
        "khaledEmotion": "smirk",
        "valentinEmotion": "hesitate",
        "answers": [
            {
                "value": "Khaled",
                "correct": false,
                "khaledResponse": "Personnellement, je suis plutôt flexible quant à la localisation de mon futur lieu de travail. L'essentiel pour moi, c'est de trouver un environnement stimulant.",
                "khaledEmotion": "sad",
                "valentinResponse": "Exactement, je recherche activement une entreprise dans ma région. La proximité me permettrait de mieux concilier travail et vie personnelle.",
                "valentinEmotion": "sweat"
            },
            {
                "value": "Valentin",
                "correct": true,
                "khaledResponse": "Pour ma part, je suis ouvert à travailler n'importe où tant que les conditions sont bonnes. La distance n'est pas un problème pour moi.",
                "khaledEmotion": "wink",
                "valentinResponse": "C'est crucial pour moi. Réduire les temps de trajet me permettrait d'avoir plus de temps pour ma famille et mes loisirs.",
                "valentinEmotion": "happy"
            }
        ]
    }
